...
920 PRINT " Min. hopper slope";USING "###.#ø";N
930 COLOR 0,7
...
1200 COLOR 0,7:C=30
1210 LOCATE ,C:PRINT "                  "
1220 LOCATE ,C:PRINT "  ³®Ä F Ä¯³       "
1230 LOCATE ,C:PRINT "  ÚÄÄÄÄÄÄÄ¿®Ä¿®Ä¿ "
1240 LOCATE ,C:PRINT "  ³  bin  ³  J  ³ "
1250 LOCATE ,C:PRINT "  ÀÄÄÄÄÄÄÄ´®Ä´  ³ "
1260 LOCATE ,C:PRINT "   \hopper³  H  M "
1270 LOCATE ,C:PRINT "    \     ³  ³  ³ "
1280 LOCATE ,C:PRINT "     ÀÄÄÄÄÙÄÄÙ®ÄÙ "
1290 LOCATE ,C:PRINT "   Ä¯³ D  ³®Ä     "
1300 COLOR 7,0
1310 PRINT UL$;
1320 RETURN
1330 '
